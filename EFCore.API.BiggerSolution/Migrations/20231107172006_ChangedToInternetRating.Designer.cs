...
namespace EFCore.API.BiggerSolution.Migrations
{
    ...
    [Migration("20231107172006_ChangedToInternetRating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore.API.BiggerSolution.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCore.API.BiggerSolution.Models.Movie", b =>
                {
            ...
            modelBuilder.Entity("EFCore.API.BiggerSolution.Models.Movie", b =>
                {
                    b.HasOne("EFCore.API.BiggerSolution.Models.Genre", "Genre")
                        .WithMany("Movies")
                        .HasForeignKey("MainGenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("EFCore.API.BiggerSolution.Models.Person", "Actors", b1 =>
                        {
                    ...
                    b.OwnsOne("EFCore.API.BiggerSolution.Models.Person", "Director", b1 =>
                        {
                            b1.Property<int>("MovieIdentifier")
                                .HasColumnType("int");
